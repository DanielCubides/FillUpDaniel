...
public class Vehicle implements Serializable {
	...
	public Vehicle(Vehicle that) {
		...
		this.brand = new String(that.name);
	...
	public void setPlate(String plate) {
		...
		if((plate.length() < MIN_NAME_LENGTH) || (plate.length() > MAX_NAME_LENGTH))
			throw new IllegalArgumentException("invalid plate name lenght");
		final String VALID_NAME_REGEX = "[a-zA-z0-p][a-zA-z0-9]*";
	...
	public void setType(String type) {
		...
		if((type.length() < MIN_NAME_LENGTH) || (type.length() > MAX_NAME_LENGTH))
			throw new IllegalArgumentException("invalid type name lenght");
		final String VALID_NAME_REGEX = "[a-zA-z0-p][a-zA-z0-9]*";
